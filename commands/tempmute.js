...
module.exports = {
    run: async (message, args) => {
        ...
        .setColor(`#00cfff`)
        .setAuthor(`${member.user.tag} a été mute pendant ${humanizeDuration(duration, {language: 'fr'})} !`, member.user.displayAvatarURL()))
        ...
        setTimeout(() => {
            ...
            message.channel.send(new Discord.MessageEmbed()
            .setColor(`#00cfff`)
            .setAuthor(`${member.user.tag} a été unmute.`, member.user.displayAvatarURL()))
        }, duration)
    },
    name: 'tempmute',
    guildOnly: true,
